...
"""
class Tbot2Canonical(Node):

    def __init__(self):
        super().__init__('Tbot2Canonical')
        self.get_logger().info('Starting Tbot2Canonical')
...
def main(args=None):
    ...
    tbot2Canonical = Tbot2Canonical()

    rclpy.spin(tbot2Canonical)
